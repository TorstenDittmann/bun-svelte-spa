<script lang="ts">
	...
	let { user, showActions = true, compact = false }: {
		user: User;
		showActions?: boolean;
		compact?: boolean;
	} = $props();
...
<div class="user-card" class:compact>
	...
	{#if showActions}
		<div class="user-actions">
			...
			<a href="/users/{user.id}/posts" class="btn btn-secondary btn-sm">
				Posts
			</a>
			<a href="/users/{user.id}/albums" class="btn btn-secondary btn-sm">
				Albums
			</a>
		</div>
	{/if}
