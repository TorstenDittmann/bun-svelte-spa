	...
	<div class="not-found-content">
		...
		<div class="navigation-options">
			...
			<div class="options-grid">
				<button class="option-card" onclick={() => goto("/")}>
					<div class="option-icon">🏠</div>
					<h3>Go Home</h3>
					<p>Return to the homepage</p>
				</button>

				<button class="option-card" onclick={() => goto("/dashboard")}>
					<div class="option-icon">📊</div>
					<h3>Dashboard</h3>
					<p>View statistics and recent activity</p>
				</button>

				<button class="option-card" onclick={() => goto("/users")}>
					<div class="option-icon">👥</div>
					<h3>Browse Users</h3>
					<p>Explore user profiles</p>
				</button>

				<button class="option-card" onclick={() => goto("/posts")}>
					<div class="option-icon">📝</div>
					<h3>Read Posts</h3>
